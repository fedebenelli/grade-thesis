...
# --------------------------
years = range(int(sys.argv[1]))   # Años a calcular el flujo de fondos
I0    = 9206       # Valor de inversión inicial
egr   = 7711*3     # Valor de egresos anuales
